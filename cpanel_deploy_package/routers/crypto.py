...
async def analyze_crypto_market(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Crypto AI analysis failed: {str(e)}")
...
async def analyze_candlestick(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Candlestick AI analysis failed: {str(e)}")
